  ...
  return (
    <section className="flex h-full items-center justify-center p-8">
      <div className="max-w-2xl rounded-[32px] border border-slate-800 bg-slate-950/70 p-8 shadow-2xl">
        ...
        <p className="mt-4 text-base leading-7 text-slate-300">scene object를 선택·복사·이동·수정하는 일반 오브젝트 에디터입니다. 상단뷰 기반으로 배치를 다루고, Grid Snap은 scene object 공통 grid snap으로 동작하며, Apply는 preview/export 기준 상태를 갱신하고 Export는 수정된 GLB를 다시 만듭니다.</p>
        ...
        <ul className="mt-8 space-y-2 text-sm text-slate-400">
          ...
          <li>• Grid Snap: Lift / Port / 배경 오브젝트 공통 grid snap</li>
