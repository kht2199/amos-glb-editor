...
export function ValidationDrawer() {
  ...
  return (
    <aside className={cn('absolute right-0 top-0 z-20 h-full w-[360px] border-l border-slate-800 bg-slate-950/95 p-4 transition-transform duration-200', isValidationOpen ? 'translate-x-0' : 'translate-x-full')}>
